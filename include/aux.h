...
#define GENOCIDE_TIME 600  // no idea which time would be optimal
...
//updates mutation
inline void update_mut_rate(char &best_changed, int &stall_num, double &mut_rate)
{
    if (!best_changed) {
